...
exp1.loc[exp1['Category']!='sales','Amount'] *= -1
...
exp2.loc[exp2['Category']!='sales','Amount'] *= -1
...
exp3.loc[exp3['Category']!='sales','Amount'] *= -1
...
exp4.loc[exp4['Category']!='sales','Amount'] *= -1
...
exp5.loc[exp5['Category']!='sales','Amount'] *= -1
```
